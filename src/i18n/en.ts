export const en = {
  ...
  share: "Share",
  scanWhy: "Why?",
  welcomeSub: "Your everyday companion for Muslim life in Kansai.",
  welcomeF1: "Prayer times and qibla, even offline",
  welcomeF2: "Mosques, prayer rooms and halal food nearby",
  welcomeF3: "Check Japanese food labels in seconds",
  welcomeF4: "Understand the Friday khutbah in your language",
  ...
  evRamadan: "Ramadan begins",
  evEidFitr: "Eid al-Fitr",
  evArafah: "Day of Arafah",
  evEidAdha: "Eid al-Adha",
  evHijriNewYear: "Islamic New Year",
  evAshura: "Ashura",
  evToday: "Today",
  evTomorrow: "Tomorrow",
  evInDays: "in {n} days",
  evEstimate: "Estimated date (Umm al-Qura). Moon sighting may change it by a day: follow your mosque.",
  evNextTitle: "Coming up",
  textSize: 'Text size',
  textNormal: 'Normal',
  textLarge: 'Large',
  textXLarge: 'Larger',
