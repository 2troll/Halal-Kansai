export const en = {
  ...
  foodScanPlaceholder: 'e.g. 豚脂、料理酒、乳化剤 — or just: mirin',
  foodScanBtn: 'Check',
  foodClear: 'Clear',
  foodHaram: 'Forbidden',
  foodDoubtful: 'Doubtful',
  foodHalal: 'Lawful',
  foodMatchedAs: 'Found on the label as',
  foodNoMatch: 'Not in the database. That does not mean it is lawful — ask.',
  foodInconclusive: 'Nothing recognised',
  foodInconclusiveNote: 'No known term was found. This is not a clearance: the database is not exhaustive, and labels do not list everything. When in doubt, ask.',
  foodVerdictNote: 'Worst finding on this label. Details below.',
