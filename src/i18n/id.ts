...
export const id: Dict = {
  ...
  salatNow: "Sekarang",
  markPrayed: "Tandai sudah salat",
  prayedToday: "salat hari ini",
  qiblaTurnRight: "Putar ke kanan",
  qiblaTurnLeft: "Putar ke kiri",
  compassAccuracyGood: "Akurasi baik",
  compassAccuracyLow: "Akurasi rendah",
  khutbahMoreOptions: "Opsi lainnya",
  possibleQuran: "Kemungkinan ayat Al-Qur’an — ditampilkan sesuai bacaan, tanpa terjemahan",
  readerDim: "Redupkan",
  readerOriginal: "Teks asli",
  readerTextSmaller: "Perkecil teks",
  readerTextBigger: "Perbesar teks",
  historyTitle: "Khutbah sebelumnya",
  historyEmpty: "Saat Anda berhenti mendengarkan, khutbah disimpan di sini, di ponsel Anda.",
  historyDelete: "Hapus",
  historyVerses: "ayat",
  ...
  share: "Bagikan",
  scanWhy: "Kenapa?",
  welcomeSub: "Teman sehari-hari untuk hidup sebagai Muslim di Kansai.",
  welcomeF1: "Waktu salat dan kiblat, bahkan tanpa internet",
  welcomeF2: "Masjid, musala, dan makanan halal terdekat",
  welcomeF3: "Cek label makanan Jepang dalam hitungan detik",
  welcomeF4: "Pahami khotbah Jumat dalam bahasamu",
  ...
  evEidAdha: "Iduladha",
  evHijriNewYear: "Tahun Baru Islam",
  evAshura: "Asyura",
  evToday: "Hari ini",
  evTomorrow: "Besok",
  evInDays: "{n} hari lagi",
  evEstimate: "Tanggal perkiraan (Umm al-Qura). Rukyatul hilal bisa menggesernya sehari: ikuti masjid Anda.",
  evNextTitle: "Mendatang",
