...
export const ja: Dict = {
  ...
  settings: "設定",
  permsTitle: "権限",
  permsHint: "アプリは、権限が必要な機能を使うときにだけ許可を求めます。",
  permLocation: "位置情報",
  permLocationWhy: "礼拝時刻、キブラ、近くの場所に使います。計算はお使いのスマートフォン内で行います。",
  permCamera: "カメラ",
  permCameraWhy: "原材料表示やバーコードを読み取るために使います。写真は保存も送信もされません。",
  permMic: "マイク",
  permMicWhy: "金曜日の説教(フトバ)を聞き取って翻訳するために使います。録音は一切しません。",
  permNotifications: "通知",
  permNotificationsWhy: "礼拝時刻とジュムア(金曜礼拝)のお知らせです。",
  permGranted: "許可済み",
  permDenied: "ブロック中",
  permPrompt: "未確認",
  permUnknown: "不明",
  permAsk: "許可する",
  permDeniedHelp: "ブロックした権限を変更するには、スマートフォンの「設定」→「アプリ」→「Halal Kansai」→「権限」を開いてください。",
  aboutTitle: "このアプリについて",
  aboutVersion: "バージョン",
  aboutMadeBy: "制作",
  aboutWhyTitle: "このアプリをつくった理由",
  aboutWhy: "日本でムスリムとして暮らしていると、毎日同じ疑問が浮かびます。礼拝は何時か、どこで礼拝できるか、この食べ物はハラールか、イマームは何と言ったのか。その答えは、さまざまなウェブサイトやグループ、言語に散らばっていました。Halal Kansaiはそれらを一か所にまとめ、無料で、一人ひとりの言語で、広告なし・アカウント不要・追跡なしでお届けします。",
  aboutNonProfit: "コミュニティのための非営利プロジェクトです。",
  aboutSource: "ソースコード",
  aboutContact: "お問い合わせ",
  legalTitle: "法的情報",
  legalPrivacy: "プライバシーポリシー",
  legalReligious: "説教(フトバ)の翻訳は理解を助けるためのものであり、ファトワーや公式の宗教文書ではありません。クルアーンの章句は、検証済みのTanzilのテキストのみを使用しています。",
  legalHalal: "原材料のチェックは目安であり、ハラール認証ではありません。判断に迷う場合は、製造元に問い合わせるか、認証マークを確認してください。",
  legalTimes: "礼拝時刻は天文学的に計算しています。地元のモスクが異なる時刻を発表している場合は、モスクに従ってください。",
  legalPlaces: "場所の情報は変わることがあります。お出かけ前にご確認ください。",
  creditsTitle: "クレジットとライセンス",
  salatNow: "今",
  markPrayed: "礼拝済みにする",
  prayedToday: "今日の礼拝",
  qiblaTurnRight: "右に回ってください",
  qiblaTurnLeft: "左に回ってください",
  compassAccuracyGood: "精度：良好",
  compassAccuracyLow: "精度：低い",
  khutbahMoreOptions: "その他のオプション",
  possibleQuran: "クルアーンの可能性あり — 朗誦のまま表示し、翻訳しません",
  readerDim: "暗くする",
  readerOriginal: "原文",
  readerTextSmaller: "文字を小さく",
  readerTextBigger: "文字を大きく",
  historyTitle: "過去のフトバ",
  historyEmpty: "聴くのをやめると、フトバはこのスマートフォンに保存されます。",
  historyDelete: "削除",
  historyVerses: "節",
  ...
  share: "共有",
  scanWhy: "理由は？",
  welcomeSub: "関西でのムスリム生活を、毎日そっとサポートします。",
  welcomeF1: "礼拝時間とキブラ、オフラインでも",
  welcomeF2: "近くのモスク・礼拝室・ハラールフード",
  welcomeF3: "日本の食品表示を数秒でチェック",
  welcomeF4: "金曜礼拝のフトバをあなたの言語で",
  ...
  evRamadan: "ラマダン開始",
  evEidFitr: "イード・アル＝フィトル",
  evArafah: "アラファの日",
  evEidAdha: "イード・アル＝アドハー",
  evHijriNewYear: "イスラム暦新年",
  evAshura: "アーシューラー",
  evToday: "今日",
  evTomorrow: "明日",
  evInDays: "{n}日後",
  evEstimate: "推定日です（ウンム・アル＝クラー暦）。月の観測により1日ずれることがありますので、お近くのモスクの発表に従ってください。",
  evNextTitle: "次の行事",
  textSize: '文字の大きさ',
  textNormal: '標準',
  textLarge: '大',
