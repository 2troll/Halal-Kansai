...
export const es: Dict = {
  ...
  foodScanPlaceholder: 'p. ej. 豚脂、料理酒、乳化剤 — o solo: mirin',
  foodScanBtn: 'Comprobar',
  foodClear: 'Limpiar',
  foodHaram: 'Prohibido',
  foodDoubtful: 'Dudoso',
  foodHalal: 'Lícito',
  foodMatchedAs: 'En la etiqueta aparece como',
  foodNoMatch: 'No está en la base. Eso no significa que sea lícito: pregunte.',
  foodInconclusive: 'No se reconoció nada',
  foodInconclusiveNote: 'No se encontró ningún término conocido. Esto no es un visto bueno: la base no lo abarca todo y las etiquetas no lo declaran todo. Ante la duda, pregunte.',
  foodVerdictNote: 'Lo más grave hallado en esta etiqueta. Detalle abajo.',
