...
export const es: Dict = {
  ...
  settings: "Ajustes",
  permsTitle: "Permisos",
  permsHint: "La app solo pide un permiso cuando usas la función que lo necesita.",
  permLocation: "Ubicación",
  permLocationWhy: "Horas de rezo, qibla y lugares cercanos. Se calcula en tu teléfono.",
  permCamera: "Cámara",
  permCameraWhy: "Para leer etiquetas de ingredientes y códigos de barras. Las fotos no se guardan ni se suben.",
  permMic: "Micrófono",
  permMicWhy: "Para escuchar la jutba del viernes y traducirla. No se graba nada.",
  permNotifications: "Notificaciones",
  permNotificationsWhy: "Avisos de la hora del rezo y del Jumu'ah.",
  permGranted: "Permitido",
  permDenied: "Bloqueado",
  permPrompt: "Aún no pedido",
  permUnknown: "Desconocido",
  permAsk: "Permitir",
  permDeniedHelp: "Para cambiar un permiso bloqueado, abre Ajustes del teléfono → Aplicaciones → Halal Kansai → Permisos.",
  aboutTitle: "Acerca de",
  aboutVersion: "Versión",
  aboutMadeBy: "Hecha por",
  aboutWhyTitle: "Por qué existe esta app",
  aboutWhy: "Vivir como musulmán en Japón es hacerse cada día las mismas preguntas: ¿a qué hora es el rezo?, ¿dónde puedo rezar?, ¿esta comida es halal?, ¿qué ha dicho el imam? Las respuestas estaban repartidas entre webs, grupos e idiomas. Halal Kansai las junta en un solo sitio, gratis, en el idioma de cada persona, sin anuncios, sin cuentas y sin rastreo.",
  aboutNonProfit: "Un proyecto sin ánimo de lucro para la comunidad.",
  aboutSource: "Código fuente",
  aboutContact: "Contacto",
  legalTitle: "Legal",
  legalPrivacy: "Política de privacidad",
  legalReligious: "Las traducciones de la jutba son una ayuda para entender, no una fatwa ni un texto religioso oficial. Los versos del Corán salen solo del texto verificado de Tanzil.",
  legalHalal: "La revisión de ingredientes es una orientación, no una certificación halal. Si hay dudas, pregunta al fabricante o busca un sello de certificación.",
  legalTimes: "Las horas de rezo se calculan astronómicamente. Si tu mezquita anuncia otras horas, sigue a la mezquita.",
  legalPlaces: "Los datos de los lugares pueden cambiar. Compruébalos antes de ir.",
  creditsTitle: "Créditos y licencias",
  salatNow: "Ahora",
  markPrayed: "Marcar como rezado",
  prayedToday: "rezados hoy",
  qiblaTurnRight: "Gira a tu derecha",
  qiblaTurnLeft: "Gira a tu izquierda",
  compassAccuracyGood: "Buena precisión",
  compassAccuracyLow: "Precisión baja",
  khutbahMoreOptions: "Más opciones",
  possibleQuran: "Posible Corán — se muestra como se recitó, sin traducir",
  readerDim: "Atenuar",
  readerOriginal: "Original",
  readerTextSmaller: "Letra más pequeña",
  readerTextBigger: "Letra más grande",
  historyTitle: "Jutbas anteriores",
  historyEmpty: "Cuando dejes de escuchar, la jutba se guarda aquí, en tu teléfono.",
  historyDelete: "Borrar",
  historyVerses: "aleyas",
  historyCopy: "Copiar texto",
  historyCopied: "Copiado",
  historyBack: "Volver",
  share: "Compartir",
  scanWhy: "¿Por qué?",
  welcomeSub: "Tu compañera de cada día para la vida musulmana en Kansai.",
  welcomeF1: "Horas de rezo y qibla, incluso sin conexión",
  welcomeF2: "Mezquitas, salas de oración y comida halal cerca",
  welcomeF3: "Revisa etiquetas japonesas en segundos",
  welcomeF4: "Entiende la jutba del viernes en tu idioma",
  ...
  evRamadan: "Empieza el Ramadán",
  evEidFitr: "Eid al-Fitr",
  evArafah: "Día de Arafah",
  evEidAdha: "Eid al-Adha",
  evHijriNewYear: "Año Nuevo islámico",
  evAshura: "Ashura",
  evToday: "Hoy",
  evTomorrow: "Mañana",
  evInDays: "dentro de {n} días",
  evEstimate: "Fecha estimada (Umm al-Qura). El avistamiento de la luna puede moverla un día: sigue a tu mezquita.",
  evNextTitle: "Próxima fecha",
