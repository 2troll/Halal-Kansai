...
export const tr: Dict = {
  ...
  compassCalibrate: 'Pusulayı kalibre etmek için telefonu birkaç kez 8 çizerek hareket ettirin.',
  compassTrueNorth: 'Coğrafi kuzeye göre düzeltildi',
  ...
  mapOffline: 'Harita yüklenemedi (internet yok ya da bir VPN veya engelleyici durduruyor). Aşağıdaki liste ve yol tarifi çalışmaya devam eder.',
  ...
  themeAmoled: 'Saf siyah',
  themeSakura: 'Sakura',
  themeMatcha: 'Matcha',
  themeRamadan: 'Ramazan',
  themeKiswah: 'Kisve',
  settings: "Ayarlar",
  permsTitle: "İzinler",
  permsHint: "Uygulama yalnızca, izin gerektiren özelliği kullandığınızda izin ister.",
  permLocation: "Konum",
  permLocationWhy: "Namaz vakitleri, kıble ve en yakın yerler. Hesaplama telefonunuzda yapılır.",
  permCamera: "Kamera",
  permCameraWhy: "İçindekiler etiketlerini ve barkodları okumak için. Fotoğraflar kaydedilmez ve yüklenmez.",
  permMic: "Mikrofon",
  permMicWhy: "Cuma hutbesini dinleyip çevirmek için. Hiçbir şey kaydedilmez.",
  permNotifications: "Bildirimler",
  permNotificationsWhy: "Namaz vakti ve Cuma namazı hatırlatmaları.",
  permGranted: "İzin verildi",
  permDenied: "Engellendi",
  permPrompt: "Henüz sorulmadı",
  permUnknown: "Bilinmiyor",
  permAsk: "İzin ver",
  permDeniedHelp: "Engellenen bir izni değiştirmek için telefonunuzda Ayarlar → Uygulamalar → Halal Kansai → İzinler bölümünü açın.",
  aboutTitle: "Hakkında",
  aboutVersion: "Sürüm",
  aboutMadeBy: "Geliştiren",
  aboutWhyTitle: "Bu uygulama neden var",
  aboutWhy: "Japonya’da Müslüman olarak yaşamak, her gün aynı soruları sormak demek: Namaz saat kaçta, nerede namaz kılabilirim, bu yiyecek helal mi, imam ne dedi? Cevaplar web siteleri, gruplar ve diller arasında dağınıktı. Halal Kansai hepsini tek bir yerde topluyor: ücretsiz, herkesin kendi dilinde, reklamsız, hesapsız ve takipsiz.",
  aboutNonProfit: "Topluluk için kâr amacı gütmeyen bir proje.",
  aboutSource: "Kaynak kodu",
  aboutContact: "İletişim",
  legalTitle: "Yasal",
  legalPrivacy: "Gizlilik politikası",
  legalReligious: "Hutbe çevirileri anlamaya yardımcı olmak içindir; fetva ya da resmî dinî metin değildir. Kur’an ayetleri yalnızca doğrulanmış Tanzil metninden alınır.",
  legalHalal: "İçerik kontrolleri yol gösterme amaçlıdır, helal sertifikası değildir. Emin değilseniz üreticiye sorun veya sertifika işaretine bakın.",
  legalTimes: "Namaz vakitleri astronomik olarak hesaplanır. Bölgenizdeki cami farklı vakitler duyuruyorsa camiye uyun.",
  legalPlaces: "Mekân bilgileri değişebilir. Gitmeden önce kontrol edin.",
  creditsTitle: "Emeği geçenler ve lisanslar",
  salatNow: "Şimdi",
  markPrayed: "Kılındı olarak işaretle",
  prayedToday: "bugün kılınan",
  qiblaTurnRight: "Sağına dön",
  qiblaTurnLeft: "Soluna dön",
  compassAccuracyGood: "Doğruluk iyi",
  compassAccuracyLow: "Doğruluk düşük",
  khutbahMoreOptions: "Diğer seçenekler",
  possibleQuran: "Kur’an olabilir — okunduğu gibi gösteriliyor, çevrilmedi",
  readerDim: "Karart",
  readerOriginal: "Orijinal metin",
  readerTextSmaller: "Yazıyı küçült",
  readerTextBigger: "Yazıyı büyüt",
  historyTitle: "Önceki hutbeler",
  historyEmpty: "Dinlemeyi bıraktığınızda hutbe burada, telefonunuzda saklanır.",
  historyDelete: "Sil",
  historyVerses: "ayet",
  ...
  share: "Paylaş",
  scanWhy: "Neden?",
  welcomeSub: "Kansai'de Müslüman hayatı için her gün yanınızda.",
  welcomeF1: "Namaz vakitleri ve kıble, internetsiz bile",
  welcomeF2: "Yakındaki camiler, mescitler ve helal yemek",
  welcomeF3: "Japonca gıda etiketlerini saniyeler içinde kontrol edin",
  welcomeF4: "Cuma hutbesini kendi dilinizde anlayın",
  ...
  evRamadan: "Ramazan başlıyor",
  evEidFitr: "Ramazan Bayramı",
  evArafah: "Arefe Günü",
  evEidAdha: "Kurban Bayramı",
  evHijriNewYear: "Hicri Yılbaşı",
  evAshura: "Aşure",
  evToday: "Bugün",
  evTomorrow: "Yarın",
  evInDays: "{n} gün sonra",
  evEstimate: "Tahmini tarih (Ümmü'l-Kurâ). Hilalin görülmesiyle bir gün değişebilir: camiinizi takip edin.",
  evNextTitle: "Yaklaşan",
